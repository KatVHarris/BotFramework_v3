            ...
            if (activity != null)
            {
                ...
                switch (activity.GetActivityType())
                {
                    case ActivityTypes.Message:
                        ...
                        //await Conversation.SendAsync(activity, () => new AttachmentDialog());
                        //await Conversation.SendAsync(activity, () => new SimpleDialog());
                        await Conversation.SendAsync(activity, () => new LUISCalls());
                        break;
                        ...
                        using (var scope = DialogModule.BeginLifetimeScope(Conversation.Container, activity))
                        {
                            ...
                            if (update.MembersAdded.Any())
                            {
                                ...
                                foreach (var newMember in update.MembersAdded)
                                {
                                    ...
                                    {
                                        reply.Text = $"New Conversation {activity.From.Name}";
                                    }
